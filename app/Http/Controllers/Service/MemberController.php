...
//    // 手机号注册
    ...
    // 邮箱注册
      ...
      $tmpEmail = Member::where('email', $email)->first();
      if($tmpEmail!=null){
          $m3_result->status = 6;
          $m3_result->message = '该邮箱已经被注册了';
          return $m3_result->toJson();
      }
      ...
      $m3_email->to = $email;
      $m3_email->cc = 'songyaozu1314520@163.com';
      $m3_email->subject = '测试专用';
      ...
      Mail::send('email_register', ['m3_email' => $m3_email], function ($m) use ($m3_email) {
          $m->from('songyaozu1314520@163.com', 'Your Application');
